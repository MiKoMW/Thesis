...
Table\ref{tab:datacount} shows various count about the data set. 
...
\subsection{Multi-modal deep neural network architecture with hierarchical attentional encoder}
\noindent
